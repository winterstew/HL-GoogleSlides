...
class GoogleSlideMatcher(Matcher):
    ...
    ********
    ...
    'otherspeed': "{{fly:|flyspeed}}\x1f{{(_flymaneuver)}}\x1f{{climb:|climbspeed}}\x1f{{swim:|swimspeed}}\x1f{{burrow:|burrowspeed}}\x1f{{jet:|jetspeed}}\x1f{{surge:|surgespeed}}\x1f{{leap}}\x1f{{icewalking}}\x1f{{earthglide}}\x1f{{airwalk}}\x1f{{waterwalk}}\x1f{{cloudwalking}}\x1f{{cloudwalking}}\x1f{{swiftflight}}\x1f{{sidewaysscuttle}}\x1f{{gracefulflight}}",
    ...
    'useMagicDevice':"feature.skills.useMagicDevice.text",
    ...
    'useMagicDevices':"feature.skills.useMagicDevice.situationalmodifiers.text",
    ...
    'melee weapons quantity': "feature.melee.weaponList[0].quantity",
    'melee weapons weight': "feature.melee.weaponList[0].weightLbs",
    'melee weapons cost': "feature.melee.weaponList[0].costGp",
    'melee weapons name': "feature.melee.weaponList[0].name",
    'melee weapons category': "feature.melee.weaponList[0].categorytext",
    'melee weapons type': "feature.melee.weaponList[0].typetext",
    'melee weapons size': "feature.melee.weaponList[0].size",
    'melee weapons attack': "feature.melee.weaponList[0].attack",
    'melee weapons crit': "feature.melee.weaponList[0].crit",
    'melee weapons damage': "feature.melee.weaponList[0].damage",
    'melee weapons rangeattack': "feature.melee.weaponList[0].rangeattack",
    'melee weapons rangeinc': "feature.melee.weaponList[0].rangeinc",
    ...
    'range weapons quantity': "feature.ranged.weaponList[0].quantity",
    'range weapons weight': "feature.ranged.weaponList[0].weightLbs",
    'range weapons cost': "feature.ranged.weaponList[0].costGp",
    'range weapons name': "feature.ranged.weaponList[0].name",
    'range weapons category': "feature.range.weaponList[0].categorytext",
    'range weapons type': "feature.range.weaponList[0].typetext",
    'range weapons size': "feature.range.weaponList[0].size",
    'range weapons attack': "feature.range.weaponList[0].attack",
    'range weapons crit': "feature.range.weaponList[0].crit",
    'range weapons damage': "feature.range.weaponList[0].damage",
    'range weapons rangeattack': "feature.range.weaponList[0].rangeattack",
    'range weapons rangeinc': "feature.range.weaponList[0].rangeinc",
    'range equipped weapons': "feature.ranged.weaponList[0].equipped\x1dfeature.ranged.weaponList[0].summary",
    'defenses armor': "feature.defenses.armorList[0].namequant",
    'defenses armor quantity': "feature.defenses.armorList[0].quantity",
    'defenses armor weight': "feature.defenses.armorList[0].weightLbs",
    'defenses armor cost': "feature.defenses.armorList[0].costGp",
    'defenses armor name': "feature.defenses.armorList[0].name",
    'defenses armor ac': "feature.defenses.armorList[0].ac",
    'defenses armor size': "feature.defenses.armorList[0].size",
    'defenses armor itemslot': "feature.defenses.armorList[0].itemslottext",
    'defenses equipped armor': "feature.defenses.armorList[0].equipped == yes\x1dfeature.defenses.armorList[0].namequant",
    'magic items': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].namequant",
    'magic items quantity': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].quantity",
    'magic items weight': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].weightLbs",
    'magic items cost': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].costGp",
    'magic items name': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].name",
    'magic items size': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].size",
    'magic items itemslot': "feature.magicitems.itemList[0].quantity > 0\x1dfeature.magicitems.itemList[0].itemslottext",
    'gear items': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].namequant",
    'gear items quantity': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].quantity",
    'gear items weight': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].weightLbs",
    'gear items cost': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].costGp",
    'gear items name': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].name",
    'gear items size': "feature.gear.itemList[0].quantity > 0\x1dfeature.gear.itemList[0].size",
    'allitems': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].summary",
    'allitems quantity': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].quantity",
    'allitems weight': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].weightLbs",
    'allitems cost': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].costGp",
    'allitems name': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].name",
    'allitems category': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].categorytext",
    'allitems type': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].typetext",
    'allitems attack': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].attack",
    'allitems crit': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].crit",
    'allitems damage': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].damage",
    'allitems rangeattack': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].rangeattack",
    'allitems rangeinc': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].rangeinc",
    'allitems ac': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].ac",
    'allitems itemslot': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].itemslottext",
    'allitems size': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].size",
    'allitems realmworkscategory': "feature.allitems.itemList[0].quantity > 0\x1dfeature.allitems.itemList[0].realmworkscategory",
